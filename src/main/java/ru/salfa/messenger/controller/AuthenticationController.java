...
public class AuthenticationController {
    ...
    ResponseEntity<SignInResponse> signIn(@Valid @RequestBody SignInRequest request,
        ...
        var refreshCookie = new Cookie("refreshToken", signInResponse.refreshToken());
        refreshCookie.setHttpOnly(true);
        refreshCookie.setSecure(false);
        refreshCookie.setPath("/api/v1/auth/refreshTokens");
    ...
    ResponseEntity<?> refreshTokens(HttpServletRequest request, HttpServletResponse response,
        ...
        var refreshCookie = new Cookie("refreshToken", tokens.refreshToken());
        refreshCookie.setHttpOnly(true);
        refreshCookie.setSecure(false);
        refreshCookie.setPath("/api/v1/auth/refreshTokens");
